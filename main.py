...
def main():
    ...
    p2 = Pessoa('Giovanni', -16.8799,-49.255,'developer',True,2)
    p3 = Pessoa('Ricardo',-16.5799,-49.255,'developer',True,3)
    p4 = Pessoa('Regis',-19.6799, -49.255,'developer',True,4)
    ...
    tiposProfissional = ['developer','faxineiro']
    profissionaisRaio = service.subLista(lista,usuario,750,tiposProfissional)
